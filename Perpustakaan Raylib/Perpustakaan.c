...
int main()
{
    ...
    InitAudioDevice();
    Sound tc = LoadSound("coin.wav");
    Music xm = LoadMusicStream("back.xm");
    PlayMusicStream(xm);
    
    Image load = LoadImage("load.png");
    Image home = LoadImage("home.png");
    Image cert = LoadImage("insert.png");
    Image pus = LoadImage("del.png");
    Image pus1 = LoadImage("del1.png");
    Image see = LoadImage("boardn.png");
    Image abc = LoadImage("abc.png");
        ...
        switch(currentScreen) 
        {
            ...
            switch(currentScreen) 
            {
                ...
                case VIEW: 
                {
                    ...
                    DrawText("Tekan F5 untuk kembali.", 40, 715, 20, BLUE);
